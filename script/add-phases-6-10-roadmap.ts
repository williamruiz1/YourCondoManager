  ...
  },
  {
    ...
    workstreams: [
      ...
      },
      {
        ...
        description: "Replace static state templates with a managed regulatory-record system backed by authoritative sources, freshness metadata, and periodic reviewed updates.",
        orderIndex: 3,
        tasks: [
          {
            title: "Regulatory source registry data model",
            description: "Registry of jurisdiction records with source URL, source authority, effective date, last verified date, last updated date, and regulatory content metadata.",
            effort: "medium",
            priority: "high",
          },
          {
            title: "Jurisdiction record sync and publication workflow",
            description: "Fetch or stage updated regulatory records from authoritative internet sources, review them, and publish approved updates into the platform record base.",
            effort: "medium",
            priority: "high",
          },
          {
            title: "Regulatory record versioning and change tracking",
            description: "Track version history and effective periods so statutory updates do not overwrite prior compliance records.",
            effort: "medium",
            priority: "medium",
          },
          {
            title: "Association regulatory applicability overlay",
            description: "Allow association-level additions on top of the managed regulatory record base for bylaw-specific obligations.",
            effort: "small",
            priority: "medium",
          },
          {
            title: "Regulatory record staleness monitoring",
            description: "Track record freshness, flag overdue verification windows, and schedule periodic review/update sweeps.",
            effort: "small",
            priority: "medium",
          },
        ],
