...
export const CHART_OF_ACCOUNTS: readonly GlAccountDef[] = [
  ...
  // Income
  acct("4000", "Assessment Income", "income", "operating"),
 ...
 *
 *   CHARGE / ASSESSMENT / LATE-FEE (amount > 0, owner billed):
 *       DR  1200 Accounts Receivable        (asset ↑)
 *       CR  4000 Assessment Income          (income ↑)
 *
 ...
 *       DR  4000 Assessment Income          (income ↓ — reverse the billing)
...
export function postOwnerLedgerEntry(entry: OwnerLedgerEntryLike): JournalEntry {
  ...
  switch (entry.entryType) {
    ...
    case "assessment":
    case "late-fee": {
      // Billing: DR Accounts Receivable, CR Income.
      legs = [
