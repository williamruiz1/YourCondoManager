...
export async function seedDatabase() {
  ...
  // Wrap each top-level seed block in `runBlock` so a single failure
  // (e.g., a FK violation in the electionBallotTokens insert) is logged
  // but does NOT abort the seed function before later blocks (Cherry
  // Hill persons, ownerships, ledger, balance entries) get a chance to
  // run. Idempotency invariants of each block must hold on partial DB
  // state — this is the goal of every `onConflictDoNothing` /
  // existence-check in seed.ts.
  async function runBlock(name: string, fn: () => Promise<void>): Promise<void> {
    const t0 = Date.now();
    try {
      await fn();
      log(`[seed] block ok :: ${name} (${Date.now() - t0}ms)`, "seed");
    } catch (err) {
      const message = err instanceof Error ? err.message : String(err);
      log(`[seed] block FAILED :: ${name} (${Date.now() - t0}ms) :: ${message}`, "seed");
      console.error(`[seed] block "${name}" failed; continuing to next block:`, err);
    }
  }

  // Hoisted from the CHC buildings block so every later wrapped block
  // can still reference it even when an earlier block fails.
  const CHERRY_HILL_CONDO_ID = "f301d073-ed84-4d73-84ce-3ef28af66f7a";
  await runBlock("associations", async () => {
  ...
  await runBlock("db-counts-log", async () => {
  ...
  await runBlock("chc-buildings-and-units", async () => {
  ...
  await runBlock("known-admin-users", async () => {
  ...
  await runBlock("roadmap-projects", async () => {
  ...
  await runBlock("roadmap-phase-6", async () => {
  ...
  await runBlock("roadmap-reliability", async () => {
  ...
  await runBlock("platform-admin-emails-env", async () => {
  ...
  await runBlock("roadmap-deploy-stability", async () => {
  ...
  await runBlock("roadmap-mobile-optimization", async () => {
  ...
  await runBlock("roadmap-lease-redesign", async () => {
  ...
  await runBlock("work-orders", async () => {
    // ── 6: Work Orders ──
  ...
  await runBlock("insurance-policies", async () => {
    // ── Insurance Policies ──────────────────────────────────────────────────────
  ...
  await runBlock("inspection-records", async () => {
    // ── Inspection Records ───────────────────────────────────────────────────────
  ...
  await runBlock("maintenance-templates", async () => {
  ...
  await runBlock("maintenance-instances", async () => {
  ...
  await runBlock("governance-meetings", async () => {
    // ── Governance Meetings ──────────────────────────────────────────────────────
  ...
  await runBlock("budget-versions", async () => {
    // ── Budget Versions ───────────────────────────────────────────────────────────
  ...
  await runBlock("budget-lines", async () => {
    // ── Budget Lines ──────────────────────────────────────────────────────────────
  ...
  await runBlock("owner-ledger-entries-chc", async () => {
  ...
  await runBlock("late-fee-rules-chc", async () => {
  ...
  await runBlock("late-fee-events-chc", async () => {
  ...
  await runBlock("resident-feedback-chc", async () => {
  ...
  await runBlock("onboarding-invites-chc", async () => {
  ...
  await runBlock("vendor-invoices", async () => {
    // ── Vendor Invoices ──
  ...
  await runBlock("payment-plans-chc", async () => {
  ...
  await runBlock("chc-real-persons", async () => {
  ...
  await runBlock("chc-real-ownerships", async () => {
  ...
  await runBlock("driveway-assessment-chc", async () => {
  ...
  await runBlock("opening-balance-ledger-chc", async () => {
  ...
  await runBlock("chc-test-hoa", async () => {
  ...
  await runBlock("chc-community-hub-config", async () => {
  ...
  await runBlock("platform-admin-warning", async () => {
