        ...
        <CardContent className="p-0">
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center py-16 text-center">
              ...
              <p className="text-sm text-muted-foreground mt-1 max-w-sm">An association is your community or HOA entity. Create one first — it becomes the context for all units, owners, finances, and governance in this platform.</p>
            </div>
          ) : (
            <Table>
              <TableHeader>
