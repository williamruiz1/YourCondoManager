...
describe("computeDueNow — dues vs assessment-installment separation", () => {
  it("sums the server-resolved current-period categories", () => {
    const r = computeDueNow([{ dueNowDues: 355, dueNowAssessment: 0 }]);
  ...
  it("assessment shows only the INSTALLMENT due now, not the full lump", () => {
    ...
    const r = computeDueNow([{ dueNowDues: 330, dueNowAssessment: 2000 }]);
  ...
  it("sums installments across multiple upcoming items", () => {
    const r = computeDueNow([{ dueNowDues: 100, dueNowAssessment: 500 }]);
  ...
  it("ignores negative/credit category balances in dues-due", () => {
    const r = computeDueNow([{ dueNowDues: 0, dueNowAssessment: 0 }]);
  ...
  it("aggregates dues across multiple units", () => {
    const r = computeDueNow([
      { dueNowDues: 330, dueNowAssessment: 0 },
      { dueNowDues: 170, dueNowAssessment: 0 },
    ]);
