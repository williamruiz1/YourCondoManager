      ...
      <CardContent className="py-5">
        ...
        <div className="mt-4">
          <div className="mb-2 flex items-baseline justify-between text-sm">
            <span className="font-semibold" style={{ color: "var(--ds-accent, #15a39c)" }}>{view.pctPaid}% paid</span>
      ...
      <section className="pfx-pinned" data-testid="portal-finances-pinned">
        <div className="pfx-pin-card">
          ...
          <Link
            ...
            style={{ color: "var(--ds-accent, #15a39c)" }}
          ...
          {assessmentPlansByUnit.length === 0 ? (
            ...
            <section data-testid="portal-finances-assessments-grid">
              ...
              <div className="pfx-unit-grid">
                {assessmentPlansByUnit.flatMap((unit) =>
                  unit.plans.map((plan) => (
                    <AssessmentPlanCard
