...
> Status: SPEC LOCKED 2026-04-25 (Wave 21) · EXTENDED 2026-04-25 (Wave 24, round 2 — +15 surfaces) · EXTENDED 2026-04-26 (Wave 27, round 3 — +8 operator surfaces) · EXTENDED 2026-04-26 (Wave 31, round 4 — +4 governance/community surfaces) · EXTENDED 2026-04-26 (Wave 42 — +3 public marketing surfaces, Wave 31 deferral closed).

## What this is

A minimal, dependency-free string registry for the YCM client. There is no `i18next`, no plural engine, no interpolation engine. Wave 21 established the registry and the `t()` helper across the **top 10 user-facing surfaces**; Wave 24 extended it to 15 more operator surfaces (financial zone, operations, governance, and records). Wave 27 added 8 more operator surfaces (compliance, ops dashboard, AI ingestion). Wave 31 added the 4 governance / community-public surfaces. Wave 42 closed the brochure deferral by extracting the 3 public marketing pages (`landing.tsx`, `pricing.tsx`, `solutions.tsx`). Full translation still lands in a follow-up wave when product commits to a non-English locale.
...
| Tier 3 — settings & admin | ~~`admin-users.tsx`~~ (Wave 27), `new-association.tsx`, ~~`executive.tsx`~~ (Wave 27), `help-center.tsx`, `not-found.tsx`, ~~`landing.tsx`~~ (Wave 42), ~~`pricing.tsx`~~ (Wave 42), ~~`solutions.tsx`~~ (Wave 42), `onboarding-invite.tsx`, `plan-signup-success.tsx` | Lower-traffic; safe to defer until the locale switcher ships. Wave 42 closed the public-marketing deferral. |
